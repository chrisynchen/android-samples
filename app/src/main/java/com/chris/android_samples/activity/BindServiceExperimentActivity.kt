...
import com.chris.android_samples.databinding.ActivityBindServiceBinding
...
class BindServiceExperimentActivity : AppCompatActivity() {
    ...
    private val listener: IRemoteServiceListener = object : IRemoteServiceListener.Stub() {
        override fun updateRemainTime(remainTime: Long) {
            binding.counterTextView.text = remainTime.toString()
        }
    }
    ...
    private val serviceConnection = object : ServiceConnection {
        ...
        override fun onServiceConnected(className: ComponentName, service: IBinder) {
            ...
            binding.killProcessButton.isEnabled = true
            binding.statusTextView.text = "onServiceConnected"
        }
        ...
        override fun onServiceDisconnected(className: ComponentName) {
            ...
            remoteService = null
            binding.killProcessButton.isEnabled = false
            binding.statusTextView.text = "onServiceDisconnected"
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.killProcessButton.setOnClickListener {
            killProcess()
        }

        binding.fetchRemainTimeButton.setOnClickListener {
            binding.remainTimeTextView.text = remoteService?.remainingTime.toString()
        }
    }
    ...
    private fun killProcess() {
        try {
            remoteService?.pid?.also { pid ->
                ...
                binding.statusTextView.text = "Killed service process."
            }
